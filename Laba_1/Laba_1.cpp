    ...
    case WM_PAINT:
        {
            ...
            // Прямоугольник
            Rectangle(hdc, 150 - 70, 180, 280 + 70, 200);
            ...
            poly[5].x = poly[4].x - 40;
            poly[5].y = poly[4].y;

            poly[6].x = poly[3].x - 90;
            poly[6].y = poly[3].y;
            ...
            // Эллипс
            Ellipse(hdc, 150, 150, 280, 370);

            // Линия
            MoveToEx(hdc, 210, 120, NULL);
            LineTo(hdc, 190, 130);

            // Ломаная
            MoveToEx(hdc, 150, 440, NULL);
            LineTo(hdc, 235-35, 320);
            LineTo(hdc, 235, 320);
            LineTo(hdc, 250, 440);
